...
RSpec.describe "OmniAuth::LDAP::Adaptor" do
  describe "initialize" do
    ...
    it "setups ldap connection with anonymous" do
    ...
    it "setups ldap connection with simple" do
    ...
    it "setups ldap connection with sasl-md5" do
    ...
    it "sets the encryption method correctly" do
